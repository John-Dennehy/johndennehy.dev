...
export function Chip({ children }: ChipProps) {
	return (
		<div className="bg-brandPrimary text-brandTextLight dark:bg-brandAccent dark:text-brandPrimary rounded-full px-4 py-2 py-1 text-sm">
			{children}
		</div>
	);
}
...
export default function RoleCard(props: Role) {
	return (
		<div className="card border-2 border-brandPrimaryLight">
			<div className="card-body">
				...
				<div className="flex justify-between">
					<h4 className="text-lg font-bold">{props.type === "work" ? <WorkIcon /> : "not work"}</h4>
